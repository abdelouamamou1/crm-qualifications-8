odoo.define('crm_qualifications.leadsMenu', function (require) {
    "use strict";
    ...
    var LeadMenu = Widget.extend({
        name: 'lead_menu',
        template:'crm_qualifications.leadMenu',
        events: {
        ...
        _updateLeadPreview: function () {
            ...
            self._getLeadData().then(function (){
                self._$leadsPreview.html(QWeb.render('crm_qualifications.systray.LeadMenu.Previews', {
                    leads : self._leads
                }));
            });
        },
